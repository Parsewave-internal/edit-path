...
Craft's matching Expat library is bundled explicitly for Python XML parsing;
using an older host Expat breaks `.kdenlive` project parsing during finalization.
